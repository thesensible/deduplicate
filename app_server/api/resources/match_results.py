...
class GetCountActionTaken(Resource):
    def __init__(self):
        super().__init__()

    def get(self):
        count = MatchResult.get_count_action_taken()
        return {
            "Action Taken count": count
        }


class GetActionTaken(Resource):
    ...
    def get(self):
        ...
        pending_matches = MatchResult.get_action_taken(params['page'])
